<div class="flex flex-col items-center gap-5 border-y-2 border-lime-200 my-5">
    ...
    <form action="">
        <div class="flex flex-col">
            <label for="name" class="text-[10px]">
        ...
        <div>
            <button wire:click.prevent='create' type="submit" class="text-gray-600 bg-gradient-to-r from-lime-200 via-lime-400 to-lime-500 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-lime-300 dark:focus:ring-lime-800 font-medium rounded-md text-[8px] px-2 py-[2px] text-center me-2 mb-2">
                Crea
            </button>
